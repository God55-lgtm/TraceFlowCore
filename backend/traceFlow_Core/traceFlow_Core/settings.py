"""
Django settings for traceflow_backend project.
"""
...
MIDDLEWARE = [
    ...
    # TraceFlow middleware
    'traceflowApp.middleware.TraceFlowMiddleware',
]

ROOT_URLCONF = 'traceFlow_Core.urls'
...
WSGI_APPLICATION = 'traceFlow_Core.wsgi.application'
...
# CORS settings (for Angular dashboard)
